<template>
  <section class="login">
    <form class="form_container">
      ...
      <!-- <button title="Sign In" class="sign-in_ggl" id="buttonDiv">
      ...
      <div id="buttonDiv"></div> <!-- aqui o google -->
      <!-- <button title="Sign In" class="sign-in_apl" >
    ...
    methods: {
      google() {
        google.accounts.id.initialize({
          client_id: "202397356704-km3mll2u0poqa37u2dsmkgpo0d8msnk8.apps.googleusercontent.com",
